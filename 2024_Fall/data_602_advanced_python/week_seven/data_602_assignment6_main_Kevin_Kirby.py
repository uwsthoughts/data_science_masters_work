...
def exercise01():
    ...
    df1 = pd.DataFrame({'Name': ['John', 'Jane', 'Jim', 'Jill', 'Joe'], 'Age': [20, 21, 22, 23, 24]})   
...
def exercise02():
    ...
    '''
    # ------ Place code below here \/ \/ \/ ------
    df2 = pd.read_csv('https://storage.googleapis.com/data_science_masters_files/2024_fall/data_602_advanced_python/week_seven/data.csv')
    print(df2.head())
    # ------ Place code above here /\ /\ /\ ------
    return df2
...
def exercise04():
    ...
    data = [
        ...
        {'city': 'Los Angeles', 'data': 85},
        {'city': 'Chicago', 'data': 95},
    ]
...
def exercise06():
    ...
    '''
    # ------ Place code below here \/ \/ \/ ------
    df6 =pd.read_excel('https://storage.googleapis.com/data_science_masters_files/2024_fall/data_602_advanced_python/week_seven/data.xlsx')
    df6.columns = ['A', 'B', 'C']
    # ------ Place code above here /\ /\ /\ ------
    return df6
